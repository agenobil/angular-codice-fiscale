(function() {
    ...
    angular.module('angularCodiceFiscale', [])
        .factory('CodiceFiscale', function () {

            var service = {};

            service.tavola_mesi = ['A', 'B', 'C', 'D', 'E', 'H', 'L', 'M', 'P', 'R', 'S', 'T'];

            service.tavola_omocodie = ['L', 'M', 'N', 'P', 'Q', 'R', 'S', 'T', 'U', 'V'];

            service.tavola_carattere_di_controllo_valore_caratteri_dispari = {
            ...
            service.tavola_carattere_di_controllo_valore_caratteri_pari = {
            ...
            service.tavola_carattere_di_controllo = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";

            service.calcola_carattere_di_controllo = function (codice_fiscale) {
                var i, val = 0;
                for (i = 0; i < 15; i++) {
            ...
            service.affronta_omocodia = function (codice_fiscale, numero_omocodia) {
                // non funziona
            ...
            service.ottieni_consonanti = function (str) {
                return str.replace(/[^BCDFGHJKLMNPQRSTVWXYZ]/gi, '');
            }

            service.ottieni_vocali = function (str) {
                return str.replace(/[^AEIOU]/gi, '');
            }

            service.calcola_codice_cognome = function (cognome) {
            ...
            service.calcola_codice_nome = function (nome) {
            ...
            service.calcola_codice_data = function (gg, mm, aa, sesso) {
                var d = new Date();
                d.setYear(aa);
                d.setMonth(mm - 1);
                d.setDate(gg);
            ...
            service.trova_comune = function (pattern_comune) {
            ...
            service.calcola_codice_comune = function (pattern_comune) {
                if (pattern_comune.match(/^[A-Z]\d\d\d$/i)) return pattern_comune;
                return this.trova_comune(pattern_comune)[0][1];
            };

            service.calcola_codice = function (nome, cognome, sesso, giorno, mese, anno, luogo) {
                var codice =
